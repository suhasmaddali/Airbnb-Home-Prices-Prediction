...
* The best machine learning model could also be deployed in the cloud such as in __Amazon Web Services (AWS)__ so that we can host our product on websites and it is accessible to users across different regions. 
